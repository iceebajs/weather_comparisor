...
[~,~,phen_fore_n] = xlsread([pwd, '/new_data_sample_test.xlsx'], 1,'J5:R67');
[~,~,phen_fact_n] = xlsread([pwd, '/new_data_sample_test.xlsx'], 1,'V5:AD67');
...
xlswrite([pwd, '/output_table.xlsx'], fact_t_n, 1, 'C5:C68');
xlswrite([pwd, '/output_table.xlsx'], forecast_t_n, 1, 'D5:D68');
xlswrite([pwd, '/output_table.xlsx'], t_night, 1, 'E5:E68');

xlswrite([pwd, '/output_table.xlsx'], fact_p_n, 1, 'F5:F68');
xlswrite([pwd, '/output_table.xlsx'], forecast_p_n, 1, 'G5:G68');
xlswrite([pwd, '/output_table.xlsx'], p_night, 1, 'H5:H68');

% =============== phenomenon assessment night ==============
xlswrite([pwd, '/output_table.xlsx'], fact_phen_n, 1, 'I5:I68');
xlswrite([pwd, '/output_table.xlsx'], forecast_phen_n, 1, 'T5:T68');

% ============= day_output ================================================
% =========================================================================

xlswrite([pwd, '/output_table.xlsx'], fact_t_d, 2, 'C5:C68');
xlswrite([pwd, '/output_table.xlsx'], forecast_t_d, 2, 'D5:D68');
xlswrite([pwd, '/output_table.xlsx'], t_day, 2, 'E5:E68');

xlswrite([pwd, '/output_table.xlsx'], fact_p_d, 2, 'F5:F68');
xlswrite([pwd, '/output_table.xlsx'], forecast_p_d, 2, 'G5:G68');
xlswrite([pwd, '/output_table.xlsx'], p_day, 2, 'H5:H68');
% ============== phenomenon assessment day =================
xlswrite([pwd, '/output_table.xlsx'], fact_wind_d, 2, 'I5:I68');
xlswrite([pwd, '/output_table.xlsx'], forecast_wind_d, 2, 'T5:T68');
